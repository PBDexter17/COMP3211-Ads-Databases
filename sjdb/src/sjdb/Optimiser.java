...
/**
 * This class achieves optimization of query
 * The main ideas are,
 * ** Start with canonical form.
 * ** Move σ operators(selections) down the tree
 * ** Reorder subtrees to put most restrictive projections first
 * ** Combine × and σ to create ⨝
 * ** Move π operators(projections) down the tree
 * 
 */
